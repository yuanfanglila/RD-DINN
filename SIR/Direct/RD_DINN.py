...
import matplotlib
fig_1 = plt.figure(1, figsize=(19, 10))
plt.subplot(2, 3, 1)
...
epoch = list(np.linspace(0, 1000))
left, bottom, width, height = 0.1, 0.1, 0.8, 0.8
ax1 = fig.add_axes([left, bottom, width, height])
ax1.plot(dinn.losses[0:], label='loss_total', color='teal')
ax1.plot(dinn.loss_IC[0:], label='loss_ic', color='red')
ax1.plot(dinn.loss_BC[0:], label='loss_bc', color='g')
ax1.plot(dinn.loss_F[0:], label='loss_function', color='b')
plt.yscale('log')
