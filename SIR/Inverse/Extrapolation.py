...
dinn.DINN.load_state_dict(torch.load('./saved_models/extrapolation_dnn_64.pth', map_location=device))
[dinn.beta, dinn.alpha] = torch.load('./saved_models/extrapolation_params_64.pt', map_location=device)
